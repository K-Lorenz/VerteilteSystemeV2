...
public class HotelBookingSystem implements BookingSystem {
    ...
    private HashMap<Integer, String> hotelList = new HashMap<>();
    ...
    public void handleRequest(String booking, Socket hotelSocket){
        ...
        if (whatAmI.equals("BookingRq")) {
            successful = this.book(requestedRooms);
            ...
            successful = this.cancel(requestedRooms);
    ...
    public boolean book(int requestedRooms) {
        if (requestedRooms <= this.rooms) {
            this.rooms -= requestedRooms;
            System.out.println("HotelBookingSystem: " + requestedRooms + " rooms booked. Remaining rooms: " + rooms + ".");
            return true;
        }else {
            System.out.println("HotelBookingSystem: " + requestedRooms + " rooms could not be booked. Remaining rooms: " + rooms + ".");
            return false;
