...
/**
 * A class representing a booking request parser.
 */
public class BookingRequestParser {
    /**
     * Parses the specified request and returns a list of {@link BookingRequest}s.
     *
     * @param request the request to parse.
     * @return a list of {@link BookingRequest}s.
     */
